...
<html>
<head>
<title>KD POLYTECHNIC PATAN</title>
</head>

<body>

<marquee><h1>K.D POLYTECHNIC, PATAN</h1></marquee>
...
?>
    <h2>Home Page</h2>
    <p>Welcome to K.D Polytechnic Patan.</p>
...
?>
    ...
    <form method="post" action="index.php?page=admission">
        Name: <input type="text" name="name"><br><br>
        Course: <input type="text" name="course"><br><br>
        <input type="submit" name="admission_submit" value="Apply">
    </form>
...
elseif($page == "library") {
    ...
    $names = ["Rahul","Amit","Priya","Neha","Ravi","Kiran","Sneha","Vikas","Pooja","Ankit"];
?>
    <h2>Library Login / Add Book</h2>

    <form method="post" action="index.php?page=library">
        Book Name: <input type="text" name="book"><br><br>
        Author: <input type="text" name="author"><br><br>
        <input type="submit" name="library_submit" value="Add Book">
    </form>

<?php
    if(isset($_POST['library_submit'])) {
?>
        <h3>Book Added (Temporary)</h3>
        Book: <?php echo $_POST['book']; ?><br>
